function EcmSelectPerson(select) {
    ...
    const modal_body = modal.querySelector('.uk-modal-body'),
      	  upsert = new EcmUpsertPerson(modal_body);
  ...
  // The View element
   ...
   this.view = new EcmViewPerson(view_modal.querySelector('.uk-modal-body'))
...
Object.setPrototypeOf(EcmSelectPerson.prototype, EcmSelect.prototype);
EcmSPA.prototype.initFunctions.EcmSelectPerson = function (el) {
    this.querySelectorAll(el, '[data-select-person]')
	.forEach(e => new EcmSelectPerson(e))
}

EcmSelectPerson.prototype.currentScript = document.currentScript;

EcmSelectPerson.prototype.setCreateLabel = function (text) {
...
EcmSelectPerson.prototype.pathExpand = function (postfix = '', path = false) {
...
EcmSelectPerson.prototype.selectOption = function (opt) {
...
EcmSelectPerson.prototype.search_cache = [];
EcmSelectPerson.prototype.search = async function (q) {
    const cached = this.search_cache[q];
    // if (cached) { return cached };

    const ret = fetch(
         this.pathExpand('../rpc/person.ss')+'?q='+encodeURIComponent(q))
           .then(e => {
...
EcmSelectPerson.prototype.addOption = function (opt, pre) {
    const parent = Object.getPrototypeOf(Object.getPrototypeOf(this)),
...
EcmSelectPerson.prototype.changeOptionsFromQuery = function (q) {
